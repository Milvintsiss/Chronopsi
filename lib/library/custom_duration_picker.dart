...
class _Dial extends StatefulWidget {
  const _Dial({@required this.duration,
...
/// );
/// ```
Future<Duration> showDurationPicker({@required BuildContext context,
...
class CustomDurationPicker extends StatelessWidget {
  ...
  CustomDurationPicker({this.duration = const Duration(minutes: 0),
